...
<div class="col-lg-8">
	 <div class="col-lg-12">
           <div class="panel panel-default">
           <div class="panel-heading"><h1 class="text-left text-primary"> Technical Skill</h1></div>
		<form method="post">
	<textarea name="skill" rows='5' cols="150" style="width:100%;border:none;padding:5px" placeholder="Enter Your Skills...e.g.PHP,Java" ><?php echo $row['skill']; ?></textarea>
</div>
<hr/>
...
<input type="text" name="experience" style="width:100%;border:none;padding:5px" placeholder="Enter Your Experience" value="<?php echo $row['experience']; ?>">
</div>

<div class="panel panel-default">
           <div class="panel-heading"><h1 class="text-left text-primary">Projects</h1></div>
<textarea name="project" rows='4' cols="100" style="width:100%;border:none;padding:5px" placeholder="Enter your Details about your proejcts here"><?php echo $row['project']; ?></textarea>
<BR/><BR>
