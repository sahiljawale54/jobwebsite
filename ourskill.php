 ...
 <a href="ourskill.php" class="list-group-item active"  style="background-color:black;">Profile
  ...
  <a href="logout1.php" class="list-group-item">Log Out
 	     ...
 	     <div class="col-lg-8">
           ...
           <h3 class="panel-heading">My Profile</h3>
...
<?php
	...
	$result = $con->query($sql);
           ...
           echo "<div class='col-md-8 panel panel-default' style='width:400;height:250px'><br/>";
...
<form method="post">
		...
		<h3 class="panel-heading" style="text-transform : uppercase;">Technical Skills</h3>
			<label></label><br><br>
			<textarea name="skill" rows='5' cols="100"  style="width:100%;border:none;padding:5px"placeholder="Enter Your Skills...e.g.PHP,Java" ><?php echo $res['skill']; ?></textarea>
		<BR/><BR>
		<h3 class="panel-heading" style="text-transform : uppercase;">Experience</h3>
		<label ></label>
		<input type="text" name="experience" style=" width:100%;border:none;padding:5px" placeholder="Enter Your Experience" value='<?php echo $res['experience']; ?>'><br><br>

		<h3 class="panel-heading" style="text-transform : uppercase;">Projects</h3>
		<label></label><br>
		<textarea name="project" rows='4' cols="100"  style="width:100%;border:none;padding:5px"placeholder="Enter your Details about your proejcts here"><?php echo $res['project']; ?></textarea>
		<BR/><BR>
